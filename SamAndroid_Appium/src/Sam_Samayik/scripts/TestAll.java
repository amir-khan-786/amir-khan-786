...
public static void main(String[] args) throws InterruptedException {
	//InvalidUserLogin
	  ...
	  openBrowser("chrome");
	  FWUtils.verifyPageTitle(driver,"Sam Samayik: Ghatna Chakra"); HomePage home=
	  new HomePage(driver); home.Sign_IN();
	  ...
	  openBrowser("chrome");
	  FWUtils.verifyPageTitle(driver,"Sam Samayik: Ghatna Chakra"); HomePage home1=
	  new HomePage(driver); home1.Sign_IN(); Thread.sleep(1000);
	  ...
	  ca1.ClickOnContinueBTN(); Thread.sleep(1000); FWUtils.verifyPageTitle(driver,
	  ...
	  System.out.println("Title of Login Page "); FWUtils.verifyPageTitle(driver,
	  "Sam Samayik: Ghatna Chakra"); home2.clickONGuestName();
